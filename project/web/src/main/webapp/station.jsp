        ...
        if (stationName == null) {
            ...
            if (ticketMachineUuid == null || ticketMachineUuid.isEmpty()) {
                ...
                if (ticketMachine == null) {
                    ...
                    ticketMachineDAO.delete(ticketMachine);
...
<html>
    ...
    <body>
        ...
        <H2>Station Ticket Machines</H2>
        <table border="1">
            <tr>
                <th>Ticket Machine UUID</th>
            </tr>
            <%
            ...
            <tr>
                ...
                <td>
                    <form action="./station.jsp" method="get">
                        <input type="hidden" size="36" name="ticketMachineUuid" value="<%= ticketMachine.getUuid()%>" readonly>
                        <input type="hidden" name="stationName" value="<%=station.getName()%>">
                        <input type="hidden" name="action" value="removeTicketMachine">
                        <button type="submit" >Delete Ticket Machine</button>
                    </form>
        ...
        <form action="./station.jsp" method="get">
            ...
            <input type="hidden" name="stationName" value="<%=station.getName()%>">
            <button type="submit" >Add Ticket Machine</button>
        </form> 
